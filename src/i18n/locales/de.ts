...
export const de: Translation = {
  ...
  contact: {
    meta: {
      ...
      description:
        "Dental Centar Repić, Put Dragulina 62 F, 21220 Trogir, Kroatien. Telefon +385 21 796 241, E-Mail info@dentalrepic.com. Werktags 8:00 - 20:00.",
    },
    hero: {
      title: "KONTAKT",
      description:
    ...
    form: {
      ...
      successMessage:
        "Vielen Dank! Wir haben Ihre Anfrage erhalten und melden uns innerhalb unserer Öffnungszeiten.",
      errorMessage:
        "Senden fehlgeschlagen. Bitte versuchen Sie es erneut oder rufen Sie uns unter +385 21 796 241 an.",
    },
