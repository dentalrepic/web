...
export const en: Translation = {
  ...
  home: {
    ...
    hero: {
      ...
      imageAlt: "Dental Centar Repić clinic",
    },
    welcome: {
      ...
      imageAlt: "The Dental Centar Repić team",
    },
    servicesIntro: {
    ...
    whyUs: {
      ...
      imageAlt: "Modern equipment at the clinic",
    },
    problems: {
  ...
  about: {
    ...
    approach: {
      ...
      imageAlt: "The Dental Centar Repić clinic",
    },
    testimonials: {
  ...
  services: {
    ...
    equipment: {
      ...
      imageAlt: "Modern dental equipment",
    },
    cta: {
  ...
  contact: {
    meta: {
      ...
      description:
        "Dental Centar Repić, Put Dragulina 62 F, 21220 Trogir, Croatia. Phone +385 21 796 241, email info@dentalrepic.com. Weekdays 8:00 - 20:00.",
    },
    hero: {
      title: "CONTACT",
      description:
    ...
    form: {
      ...
      submitting: "Sending...",
      successMessage:
        "Thank you! We have received your enquiry and will contact you within our working hours.",
      errorMessage:
        "Sending failed. Please try again or call us on +385 21 796 241.",
    },
